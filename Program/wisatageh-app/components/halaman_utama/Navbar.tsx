...
const Navbar = () => {
  return (
    <>
      <nav className="flex justify-between gap-5 items-center px-20 pt-5 pb-5 border border-b-2 p-2 shadow-custom">
        <div className="p-2">
        ...
        <div className="p-2">
          <ul className="flex gap-8">
            ...
            <li>
              <Link className="font-light hover:font-bold" href={"wishlist"}>
                Wishlist
              </Link>
            </li>
            <li>
