  ...
  const packages = [
    {
      ...
      description:
        "Paket yang disesuaikan untuk menjelajahi pemandangan Lampung yang semarak, disesuaikan dengan preferensi perjalanan Anda.",
      icon: (
        <FontAwesomeIcon
          icon={faHouse}
          style={{ fontSize: "50px" }}
    ...
    },
    {
      ...
      description:
        "Tur berpemandu ahli yang menampilkan keindahan, budaya, dan tempat petualangan Lampung.",
      icon: (
        <FontAwesomeIcon
    ...
    },
    {
      ...
      description:
        "Liburan dengan akomodasi yang disesuaikan dengan kebutuhan Anda.",
      icon: (
        <FontAwesomeIcon
    ...
    },
    {
      ...
      description:
        "Wisata masakan Lampung otentik menyenangkan para penggemar kuliner.",
      icon: (
        <FontAwesomeIcon
